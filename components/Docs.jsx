                    ...
                    <div className="pure-u-md-1-5">
                        <div className="pure-menu pure-menu-open">
                            ...
                            <ul>
                                ...
                                <li>
                                    <NavLink href="/docs/plugins" context={context}>Plugins</NavLink>
                                </li>
                                <li>
                                    <NavLink href="/docs/dispatcher" context={context}>Dispatcher</NavLink>
                                </li>
                                <li>
                                    <NavLink href="/docs/stores" context={context}>Stores</NavLink>
                                </li>
                                <li>
                                    <NavLink href="/docs/actions" context={context}>Actions</NavLink>
                                </li>
                                <li>
                                ...
                                <li>
                                    <NavLink href="/docs/guides/todo-mvc" context={context}>Todo MVC</NavLink>
                                </li>
                                <li>
                                    <NavLink href="/docs/guides/chat" context={context}>Chat</NavLink>
                                </li>
